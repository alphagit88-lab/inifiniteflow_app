...
interface AddBannerModalProps {
  open: boolean
  onClose: () => void
  onBannerCreated: (banner: ClassBanner) => void
}

export function AddBannerModal({ open, onClose, onBannerCreated }: AddBannerModalProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Create a new banner with image, title, and subtitle.</DialogDescription>
        </DialogHeader>
